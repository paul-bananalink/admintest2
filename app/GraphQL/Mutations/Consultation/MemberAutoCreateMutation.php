...
class MemberAutoCreateMutation extends Mutation
{
    ...
    protected $attributes = [
        'name' => 'memberAutoCreateMutation',
        'description' => 'Member Auto Send Consultation',
    ];
    ...
    {
        return $this->consultationService->createByAutoSend($args);
    }
}
