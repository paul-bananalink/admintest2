...
return [
    ...
    //
    'schemas' => [
        'member' => \App\GraphQL\Schemas\MemberSchema::class,
        'siteInfo' => \App\GraphQL\Schemas\SiteInfoSchema::class,
        'event' => \App\GraphQL\Schemas\EventSchema::class,
        'announcement' => \App\GraphQL\Schemas\NewsBoardSchema::class,
        'note' => \App\GraphQL\Schemas\NoteSchema::class,
        'money-info' => \App\GraphQL\Schemas\MoneyInfoSchema::class,
        'consultation' => \App\GraphQL\Schemas\ConsultationSchema::class,
        'game-provider' => \App\GraphQL\Schemas\GameProviderSchema::class,
        'game' => \App\GraphQL\Schemas\GameSchema::class,
        'bet-histories' => \App\GraphQL\Schemas\BetHistorySchema::class,
        'popup' => \App\GraphQL\Schemas\PopupSchema::class,
        'sports' => \App\GraphQL\Schemas\SportsSchema::class,
        'mini-game' => \App\GraphQL\Schemas\MiniGameSchema::class,
        'roulette' => \App\GraphQL\Schemas\RouletteSchema::class,

        // No Login
        'event-list' => \App\GraphQL\Schemas\EventListSchema::class,
        'announcement-list' => \App\GraphQL\Schemas\NewsBoardListSchema::class,
        'auth' => \App\GraphQL\Schemas\AuthSchema::class,
        'banner' => \App\GraphQL\Schemas\BannerSchema::class,

        'notice' => \App\GraphQL\Schemas\NoticeSchema::class,
    ...
    'types' => [
        ...
        'NoticeType' => App\GraphQL\Types\Notice\NoticeType::class,
    ],
    ...
    //     'locations' => []
    // ]
    // 'error_formatter' => [App\GraphQL\ErrorFormatterGraphQL::class, 'formatError'],
     ...
     */
    'errors_handler' => [App\GraphQL\ErrorFormatterGraphQL::class, 'handleErrors'],
