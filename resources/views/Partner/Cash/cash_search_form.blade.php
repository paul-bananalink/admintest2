<form action="{{ route('partner.cash.index') }}" method="GET">
    <div class="panel-heading-btn-page">
        ...
        <div class="btn-group">
            <button type="submit" name="filter" value="rollback"
                class="btnstyle1 {{ request('filter') == 'rollback' ? 'btnstyle1-primary' : 'btnstyle1-inverse2' }} h-31">환수</button>
        </div>
        <div class="btn-group">
            <button type="submit" name="filter" value="EM"
                class="btnstyle1 {{ request('filter') == 'EM' ? 'btnstyle1-primary' : 'btnstyle1-inverse2' }} h-31">머니이동</button>
        </div>
        <div class="btn-group">
        ...
        <div class="btn-group">
            <button type="submit" name="filter" value="admin"
                class="btnstyle1 {{ request('filter') == 'admin' ? 'btnstyle1-primary' : 'btnstyle1-inverse2' }} h-31">관리자</button>
        </div>
