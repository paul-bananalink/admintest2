        ...
        <div id="__layout">
            <form action="{{ route('partner.authenticate') }}" method="POST">
                ...
                <div class="login-header">
                    <div class="brand">
                        <strong>
                            <i class="fa fa-cog m-r-5 text-success"></i>PARTNER MODE </strong>
                    </div>
                </div>
                ...
                <div class="login-content">
                    ...
                    <div class="form-group m-b-20">
                        <input type="password" id="member_password" name="member_password" placeholder="비밀번호를 입력하세요"
                            class="form-control input-lg">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="captcha">
                            ...
                            <div type="button" class="btn btn-danger" class="reload" id="reload-partner">
                                &#x21bb;
                            </div>
                        </div>
                    </div>
