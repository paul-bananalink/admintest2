...
@section('content-child-child-child')
    ...
    <div class="box-content">
        ...
        @endif
        <form action="{{ route('admin.page-setting.manager-banner.update', ['bPosition' => 'right']) }}" method="POST" id="page_right">
            @csrf
            <div id="sortable">
        ...
        <div class="text-center m-t">
            <button type="submit" form="page_right" class="btn btn-primary btn-lg">저장</button>
        </div>
    </div>
@endsection
