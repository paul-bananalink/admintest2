...
@section('content-child-child-child')
    ...
    <div class="box-content">
        ...
        @endif
        <form action="{{ route('admin.page-setting.manager-banner.update', ['bPosition' => 'centerBelow']) }}" method="POST" id="page_center_below">
            @csrf
            <div id="sortable">
        ...
        <div class="text-center m-t">
            <button type="submit" form="page_center_below" class="btn btn-primary btn-lg">저장</button>
        </div>
    </div>
@endsection
