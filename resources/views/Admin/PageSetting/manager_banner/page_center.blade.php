...
@section('content-child-child-child')
    ...
    <div class="box-content">
        ...
        @endif
        <form action="{{ route('admin.page-setting.manager-banner.update', ['bPosition' => 'center']) }}" method="POST" id="page_center">
            @csrf
            <div id="sortable">
        ...
        <div class="text-center m-t">
            <button type="submit" form="page_center" class="btn btn-primary btn-lg">저장</button>
        </div>
    </div>
@endsection
