<div class="dashboard-panel mt-20">
    <div class="panel panel-primary">
        ...
        <div class="panel-body background-black cst-min-hight105">
            <div class="text-center cst-font-30 leading-65"><strong><span
                        class="count_member_login">{{ $count_member_login }}</span>명</strong></div>
        </div>
    </div>
    <div class="panel panel-primary">
        <div class="panel-heading cst_panel-heading">
        ...
        <div class="panel-body background-black cst-min-hight105">
            <div class="text-center cst-font-30 leading-65">
                <strong><span class="count_member_register_today">{{ $count_member_register_today }}</span>명</strong>
            </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body background-black cst-min-hight105">
            <div class="text-center cst-font-30 leading-65"><strong><span
                        class="count_member_suspended_today">{{ $count_member_suspended_today }}</span>명</strong></div>
        ...
        <div class="panel-body background-black cst-min-hight105">
            <div class="text-center cst-font-20 h-65">
                ...
                <p class="cst-font-18"><strong>(<span
                            class="count_order_deposite_register_today">{{ $count_order_deposite_register_today }}</span>건)</strong>
                </p>
            </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body background-black cst-min-hight105">
            <div class="text-center cst-font-20 h-65">
                ...
                <p class="cst-font-18"><strong>(<span
                            class="count_money_register_withdraw_today">{{ $count_money_register_withdraw_today }}</span>건)</strong>
                </p>
            </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body background-black cst-min-hight105">
            ...
            <div class="text-center cst-font-20 h-65">
                <strong>{{ formatNumber($total_bet_today) }} 원</strong>
                <p class="cst-font-18"><strong>({{ $count_total_bet_today }} 배팅횟수)</strong></p>
            </div>
            ...
            <div class="text-center">
                @if ($sum_bet_compare >= 0)
                    <i class="glyphicon glyphicon-arrow-up blue"></i> 전일대비
                    <span class="blue">+</span>
                    <span class="blue">{{ formatNumber($sum_bet_compare) }}원 상승</span>
                @else
                    <i class="glyphicon glyphicon-arrow-down red"></i> 전일대비
                    <span class="red">-</span>
                    <span class="red">{{ formatNumber(abs($sum_bet_compare)) }}명 회</span>
                @endif
            </div>
        </div>
    </div>
    <div class="panel panel-primary">
        <div class="panel-heading cst_panel-heading">
            <h4 class="panel-title cst_panel-title">충환수익</h4>
        </div>
        <div class="panel-body background-black cst-min-hight105">
            <div class="text-center cst-font-30 leading-65">
                <strong><span
                        class="sum_money_interest_today">{{ formatNumber($sum_money_interest_today) }}</span>원</strong>
            </div>
            <div class="text-center">
                ...
                @else
                    ...
                    <span class="red">-</span>
                    <a class="red"><span
                            class="sum_money_compare">{{ formatNumber(abs($sum_money_compare)) }}</span>원</a>
                    <span class="red">하락</span>
                @endif
            </div>
        </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body background-black cst-min-hight105">
            <div class="text-center cst-font-30 leading-65">
                <strong><span
                        class="sum_money_interest_today">{{ formatNumber($bet_profit_loss_today) }}</span>원</strong>
            </div>
            <div class="text-center">
                @if ($sum_bet_profit_compare >= 0)
                    <i class="glyphicon glyphicon-arrow-up blue"></i> 전일대비
                    <span class="blue">+</span>
                    <a class="blue"><span
                            class="sum_bet_profit_compare">{{ formatNumber($sum_bet_profit_compare) }}</span>원</a>
                    <span class="blue">상승</span>
                @else
                    <i class="glyphicon glyphicon-arrow-down red"></i> 전일대비
                    <span class="red">-</span>
                    <a class="red"><span
                            class="sum_bet_profit_compare">{{ formatNumber(abs($sum_bet_profit_compare)) }}</span>원</a>
                    <span class="red">하락</span>
                @endif
            </div>
        </div>
                    ...
                    <tbody>
                        @foreach ($data_20_days_ago as $data)
                            <tr>
                                ...
                                <td>{{ formatNumber($data['bet_profit']) }}원</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
                    ...
                    <div class="col-md-3" style="align-self: center;">
                        <div class="text-center"
                            ...
                            <div>
                                ...
                                <p style="font-size: 14px;">
                                    ...
                                    @if ($sum_money_compare >= 0)
                                        <span class="blue">+ {{ formatNumber($sum_money_compare) }}원 상승
                                        </span>
                                    @else
                        ...
                        <div class="text-center"
                            ...
                            <div>
                                <p style="line-height: 80px;">
                                    <strong
                                        style="font-weight: 700; font-size: 20px;">{{ formatNumber($total_bet_today) }} 원</strong>
                                </p>
                                <p style="font-size: 14px;">
                                    <i class=" blue" @class([
                                        'glyphicon glyphicon-arrow-up',
                                        'glyphicon-arrow-up blue' => $sum_bet_compare >= 0,
                                        'glyphicon-arrow-down red' => $sum_bet_compare < 0,
                                    ])></i>
                                    <span class="text-gray m-l-20">전일대비</span>
                                    @if ($sum_bet_compare >= 0)
                                        <span class="blue">+ {{ formatNumber($sum_bet_compare) }}원 상승</span>
                                    @else
                                        <span class="red">- {{ formatNumber(abs($sum_bet_compare)) }}원 하락</span>
                                    @endif
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="text-center"
                            ...
                            <div>
                                ...
                                <p style="font-size: 14px;">
                                    <i @class([
                                        'glyphicon',
                                        'glyphicon-arrow-up blue' => $sum_money_compare_month >= 0,
                                        'glyphicon-arrow-down red' => $sum_money_compare_month < 0,
                                    ])></i>
                                    <span class="text-gray m-l-20">전일대비</span>
                                    @if ($sum_money_compare_month >= 0)
                                        <span class="blue">+ {{ formatNumber($sum_money_compare_month) }}원 상승
                                        </span>
                                    @else
                                        <span class="red">- {{ formatNumber(abs($sum_money_compare_month)) }}원 하락</span>
                                    @endif
                                </p>금월 수익현황
                            </div>
                        </div>
                        ...
                        <div class="text-center"
                            ...
                            <div>
                                ...
                                <p style="font-size: 14px;">
                                    ...
                                    <span class="text-gray m-l-20">전일대비</span>
                                    @if ($sum_bet_month >= 0)
                                        <span class="blue">+ {{ formatNumber($sum_bet_month) }}원 상승
                                        </span>
                                    @else
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td @class(['text-center'])>
                                    {{ formatNumber($sum_bet_minus_win_today_casino) }}원
                                </td>
                                <td @class(['text-center'])>
                                    {{ formatNumber($sum_bet_minus_win_today_slot) }}원
                                </td>
                            </tr>
                            <tr>
                                <th @class(['text-center'])>
                                ...
                                <td></td>
                                <td @class(['text-center'])>
                                    {{ formatNumber($sum_win_today_casino) }}원
                                </td>
                                <td @class(['text-center'])>
                                    {{ formatNumber($sum_win_today_slot) }}원
                                </td>
                            </tr>
                            <tr>
                                <th @class(['text-center'])>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="title-chart">
                                ...
                                <h5 class="pull-right text-white" style="background: rgb(0, 34, 68);">
                                    <strong>{{ $count_member_batting_today_casino }}명</strong>
                                </h5>
                                </p>
                                <div>
                    ...
                    <div class="row mt-20">
                        ...
                        <div class="col-md-4">
                            <div class="title-chart">
                                ...
                                <h5 class="pull-right text-white" style="background: rgb(0, 34, 68);">
                                    <strong>{{ $count_member_batting_today_slot }}명</strong>
                                </h5>
                                </p>
                                <div>
