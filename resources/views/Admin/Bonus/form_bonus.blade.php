<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3 class="cst_h3">
                    <i class="fa fa-file"></i> 보너스
                </h3>
                <div class="box-tool">
                    <button class="btn btn-circle btn-info show-tooltip btn-xlarge"
                        data-original-title="Import To EXCEL">
                                    ...
                                    <tr>
                                        <th class="column-table-member">
                                            <div class="table-title">
                                                파트너명
                                                @include('Admin.Common.pair_button_arrow_sort', [
                                                    'column' => 'm_partner',
                                                ])
                                            </div>
                                        </th>
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <x-common.row_info_money :member="$item->member"/> @if (data_get($item->member, 'mNick')) ({{ data_get($item->member, 'mNick') }}) @endif
                                            </td>
                                            ...
                                            <td>
                                                <a href="#" id="showMoneyInfo" data-url="{{ route('admin.bonus.info', ['id' => data_get($item, 'miNo')]) }}"
